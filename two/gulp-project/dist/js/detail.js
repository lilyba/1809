...
require(["config"], function () {
  require(["jquery", "template", "header", "jquerycookie"], function ($, template, header) {
    ...
    new Promise(function (resolve, reject) {
      ...
      $("footer").load("/html/component/footer.html", function () {//footer的交互代码
      });
      ...
      $("#add").on("click", function () {
        ...
        cartobj.goodsImage = allData.pic; //				"https://imgservice.suning.cn/uimg1/b2c/image/dDPfy_DSEmikYB9gqFjkog.jpg_800w_800h_4e";
      ...
      var big = $(".big");
      var bigImg = $("#bigImg");
      console.log(box, fdj, big, bigImg); //			fdj.attr("display", "block");
      ...
      box.on("mousemove", function (e) {
        ...
        if (_top > box.height() - fdj.height()) _top = box.height() - fdj.height(); //放大镜和大盒子显示

        big.css({
          "display": "block"
        });
        fdj.css("display", "block"); //				//放大镜的坐标
